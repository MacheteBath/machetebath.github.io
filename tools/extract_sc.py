...
def artist_md_builder():
    print("--- MacheteBath Artist MD Builder (v1.2) ---")
    ...
    if id_match:
        ...
        # --- MULTI-LINE BIO SECTION START ---
        print(f"\nPaste/Type the bio for {artist_name}.")
        ...
        # Join the lines back together with actual paragraph breaks
        full_bio = "\n".join(bio_lines)
        # --- MULTI-LINE BIO SECTION END ---
...
"""
        ...
        artists_dir = os.path.join("..", "_artists")
